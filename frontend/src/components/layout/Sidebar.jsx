...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-64 flex-col transform bg-primary text-white transition-transform duration-300 md:relative md:translate-x-0 ${
